function [violation, violationbychoice, CKB, CKBmin, CKBbychoice] = threeItemCyclicalViolationCounter(set1, choice1, set2, choice2, set3, choice3)
...
CKBmin = zeros(length(set1),length(set1),length(set1));
